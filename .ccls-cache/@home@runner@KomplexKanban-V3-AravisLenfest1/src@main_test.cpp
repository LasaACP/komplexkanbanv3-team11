...
=======
>>>>>>> bb7ed2dee662b56dd36913f95353da87ef6a008b
#include <iostream>
#include "../tests/catch_amalgamated.hpp"
#include "../lib/Complex.h"
#include "../lib/addition.h"
...
<<<<<<< HEAD
  ...
  REQUIRE(Complex(10, -2) / Complex(5, -3) ==
          Complex(1.64705882353, 1.64705882353));
...
TEST_CASE("Imaginary Part Test", "[im]") {
  cout << "Hello Catch2 Build with Catch2 main()\n";
  cout << "Running tests on the hyperbolic cosine of the complex number"
       << endl;
